...
$INLINECOM /*  */
$include "./get_v_min_cb_settings.txt"
...
FILE statFile / 'results/get_v_min_modelStat.txt' /;
PUT statFile;
...
file fluxFileMin / 'results/get_vmin_flux_min.txt' /;
PUT fluxFileMin;
...
file fluxFileAll / 'results/get_v_min_flux_all.txt' /;
PUT fluxFileAll;
...
FILE PROTPERUP / 'results/per_up_v_min.txt' /;
PUT PROTPERUP;
